...
#ifndef ADJMATRIXGRAPHREADER_H_
#define ADJMATRIXGRAPHREADER_H_
...
namespace Graph {
    class AdjMatrixGraphReader : public GraphReader
    {
private:
    vector<int> weights;
    vector<int> degree;
