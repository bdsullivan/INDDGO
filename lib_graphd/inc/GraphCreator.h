...
namespace Graph
{
    ...
    {
      public:
        virtual WeightedMutableGraph *create_random_edge_subgraph(
			WeightedMutableGraph *wmg, int percent_edges);
        ...
        virtual list<WeightedMutableGraph *> create_all_components(
