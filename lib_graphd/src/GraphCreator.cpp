...
namespace Graph
{
	...
	*/
	WeightedMutableGraph* GraphCreator::create_random_edge_subgraph(
		WeightedMutableGraph *H, int percent_edges)
	{
	...
	*/
	WeightedMutableGraph *GraphCreator::create_induced_subgraph(
		WeightedMutableGraph *g, list<int> *members, bool make_simple)
	{
	...
	*/
	list<WeightedMutableGraph*> GraphCreator::create_all_components(
		WeightedMutableGraph *g, bool make_simple)
	{
		int i;
	...
	* is guaranteed to be simple.
	*/
	list<WeightedMutableGraph*> GraphCreator::create_rec_all_components(
		WeightedMutableGraph *g, bool make_simple)
	{
		int i, cnum = -1;
		list<WeightedMutableGraph*> C;
