...
public:
	...
	*/
    ...
    //int build_bags( int separator_switch, int current_index, int parent_index, Graph::VertexWeightedGraph *H, list<int> *parentbaglist, Graph::GraphUtil *util, Graph::Node *n2, list<int> *nbrs2 );
    void build_bags( int separator_switch, int* newbags, int current_index, int parent_index, Graph::VertexWeightedGraph *H, list<int> *parentbaglist, Graph::GraphUtil *util, Graph::Node *n2, list<int> *nbrs2 );
    //void build_bags( int separator_switch, int* newbags, int current_index, int parent_index, Graph::VertexWeightedGraph *H, list<int> *parentbaglist, list<int> *templist, Graph::GraphUtil *util, Graph::Node *n2, list<int> *nbrs2 );
